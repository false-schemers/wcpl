...
#define new_motion_word(w, m)  (new_word(w, m))
#define new_object_word(w, m)  (new_word(w, m))
#define new_action_word(w, m)  (new_word(w, m))
#define new_message_word(w, m) (new_word(w, m))
...
void build_vocabulary(void)
{
  ...
  new_motion_word("hill", ROAD);
  new_motion_word("enter", ENTER);
  new_motion_word("upstr", UPSTREAM);
  new_motion_word("downs", DOWNSTREAM);
  new_motion_word("fores", FOREST);
  new_motion_word("forwa", FORWARD);
  new_motion_word("conti", FORWARD);
  new_motion_word("onwar", FORWARD);
  new_motion_word("back", BACK);
  new_motion_word("retur", BACK);
  new_motion_word("retre", BACK);
  new_motion_word("valle", VALLEY);
  new_motion_word("stair", STAIRS);
  new_motion_word("out", OUT);
  new_motion_word("outsi", OUT);
  new_motion_word("exit", OUT);
  new_motion_word("leave", OUT);
  new_motion_word("build", HOUSE);
  new_motion_word("house", HOUSE);
  ...
  new_motion_word("inwar", IN);
  new_motion_word("insid", IN);
  new_motion_word("in", IN);
  new_motion_word("surfa", SURFACE);
  new_motion_word("null", NOWHERE);
  new_motion_word("nowhe", NOWHERE);
  new_motion_word("dark", DARK);
  new_motion_word("passa", PASSAGE);
  new_motion_word("tunne", PASSAGE);
  ...
  new_motion_word("upwar", U);
  new_motion_word("up", U);
  new_motion_word("u", U);
  new_motion_word("above", U);
  new_motion_word("ascen", U);
  new_motion_word("d", D);
  new_motion_word("downw", D);
  new_motion_word("down", D);
  new_motion_word("desce", D);
  ...
  new_motion_word("east", E);
  new_motion_word("e", E);
  new_motion_word("west", W);
  new_motion_word("w", W);
  new_motion_word("north", N);
  new_motion_word("n", N);
  new_motion_word("south", S);
  new_motion_word("s", S);
  ...
  new_motion_word("look", LOOK);
  new_motion_word("exami", LOOK);
  new_motion_word("touch", LOOK);
  new_motion_word("descr", LOOK);
  new_motion_word("floor", FLOOR);
  new_motion_word("room", ROOM);
  new_motion_word("slit", SLIT);
  new_motion_word("slab", SLAB);
  new_motion_word("slabr", SLAB);
  ...
  new_motion_word("main", OFFICE);
  new_motion_word("offic", OFFICE);
  new_motion_word("fork", FORK);

  new_object_word("key", KEYS);
  new_object_word("keys", KEYS);
  new_object_word("lamp", LAMP);
  new_object_word("lante", LAMP);
  ...
  new_object_word("magaz", MAG);
  new_object_word("issue", MAG);
  new_object_word("spelu", MAG);
  new_object_word("\"spel", MAG);
  new_object_word("dwarf", DWARF);
  new_object_word("dwarv", DWARF);
  new_object_word("knife", KNIFE);
  new_object_word("knive", KNIFE);
  new_object_word("food", FOOD);
  new_object_word("ratio", FOOD);
  new_object_word("bottl", BOTTLE);
  new_object_word("jar", BOTTLE);
  new_object_word("water", WATER);
  new_object_word("h2o", WATER);
  new_object_word("oil", OIL);
  new_object_word("mirro", MIRROR);
  new_object_word("plant", PLANT);
  new_object_word("beans", PLANT);
  new_object_word("stala", STALACTITE);
  new_object_word("shado", SHADOW);
  new_object_word("figur", SHADOW);
  ...
  new_object_word("volca", GORGE);
  new_object_word("geyse", GORGE);
  new_object_word("vendi", MACHINE);
  new_object_word("machi", MACHINE);
  new_object_word("batte", BATTERIES);
  new_object_word("moss", MOSS);
  new_object_word("carpe", MOSS);
  new_object_word("gold", GOLD);
  new_object_word("nugge", GOLD);
  new_object_word("diamo", DIAMONDS);
  new_object_word("silve", SILVER);
  new_object_word("bars", SILVER);
  new_object_word("jewel", JEWELS);
  new_object_word("coins", COINS);
  new_object_word("chest", CHEST);
  new_object_word("box", CHEST);
  new_object_word("treas", CHEST);
  new_object_word("eggs", EGGS);
  new_object_word("egg", EGGS);
  new_object_word("nest", EGGS);
  new_object_word("tride", TRIDENT);
  new_object_word("ming", VASE);
  new_object_word("vase", VASE);
  new_object_word("shard", VASE);
  new_object_word("potte", VASE);
  new_object_word("emera", EMERALD);
  new_object_word("plati", PYRAMID);
  new_object_word("pyram", PYRAMID);
  new_object_word("pearl", PEARL);
  new_object_word("persi", RUG);
  new_object_word("rug", RUG);
  new_object_word("spice", SPICES);
  new_object_word("chain", CHAIN);

  new_action_word("take", TAKE);
  new_action_word("carry", TAKE);
  new_action_word("keep", TAKE);
  new_action_word("catch", TAKE);
  new_action_word("captu", TAKE);
  new_action_word("steal", TAKE);
  new_action_word("get", TAKE);
  new_action_word("tote", TAKE);
  new_action_word("drop", DROP);
  new_action_word("relea", DROP);
  new_action_word("free", DROP);
  new_action_word("disca", DROP);
  new_action_word("dump", DROP);
  new_action_word("open", OPEN);
  new_action_word("unloc", OPEN);
  new_action_word("close", CLOSE);
  new_action_word("lock", CLOSE);
  new_action_word("light", ON);
  new_action_word("on", ON);
  new_action_word("extin", OFF);
  new_action_word("off", OFF);
  new_action_word("wave", WAVE);
  new_action_word("shake", WAVE);
  new_action_word("swing", WAVE);
  new_action_word("calm", CALM);
  new_action_word("placa", CALM);
  new_action_word("tame", CALM);
  new_action_word("walk", GO);
  new_action_word("run", GO);
  new_action_word("trave", GO);
  new_action_word("go", GO);
  new_action_word("proce", GO);
  new_action_word("explo", GO);
  new_action_word("goto", GO);
  new_action_word("follo", GO);
  new_action_word("turn", GO);
  new_action_word("nothi", RELAX);
  new_action_word("pour", POUR);
  new_action_word("eat", EAT);
  new_action_word("devou", EAT);
  new_action_word("drink", DRINK);
  new_action_word("rub", RUB);
  new_action_word("throw", TOSS);
  new_action_word("toss", TOSS);
  new_action_word("wake", WAKE);
  new_action_word("distu", WAKE);
  new_action_word("feed", FEED);
  new_action_word("fill", FILL);
  new_action_word("break", BREAK);
  new_action_word("smash", BREAK);
  new_action_word("shatt", BREAK);
  new_action_word("blast", BLAST);
  new_action_word("deton", BLAST);
  new_action_word("ignit", BLAST);
  new_action_word("blowu", BLAST);
  new_action_word("attac", KILL);
  new_action_word("kill", KILL);
  new_action_word("fight", KILL);
  new_action_word("hit", KILL);
  ...
  new_action_word("read", READ);
  new_action_word("perus", READ);
  new_action_word("fee", FEEFIE);
  new_action_word("fie", FEEFIE);
  new_action_word("foe", FEEFIE);
  new_action_word("foo", FEEFIE);
  new_action_word("fum", FEEFIE);
  new_action_word("brief", BRIEF);
  new_action_word("find", FIND);
  new_action_word("where", FIND);
...
void make_loc(Instruction *q, Location x, const char *l, const char *s, unsigned int f) 
{
  assert(x == last_x + 1);
  last_x = x;
  places[(int)x].long_desc = l;
  places[(int)x].short_desc = s;
  places[(int)x].flags = f;
  places[(int)x].objects = NOTHING;
  places[(int)x].visits = 0;
  start[(int)x] = q;
}
...
#define ditto(m) do {                              \
  make_inst(q, m, q[-1].cond, q[-1].dest);         \
  ++q;                                             \
} while(0)
...
const char *all_alike = "You are in a maze of twisty little passages, all alike.";
const char *dead_end = "Dead end.";
...
void build_travel_table(void) 
{
  ...
  make_loc(q, R_ROAD,
           ...
           "building." SOFT_NL "Around you is a forest.  A small stream flows "
                               "out of the building and" SOFT_NL
           "down a gully.",
  ...
  make_loc(
      q, R_HILL,
      "You have walked up a hill, still in the forest.  The road slopes "
      "back" SOFT_NL
      "down the other side of the hill.  There is a building in the distance.",
      "You're at hill in road.", 0);
  make_ins(ROAD, R_ROAD);
  ditto(HOUSE);
  ditto(FORWARD);
  ditto(E);
  ditto(D);
  make_ins(FOREST, R_FOREST);
  ditto(N);
  ditto(S);
  make_loc(q, R_HOUSE,
           "You are inside a building, a well house for a large spring.",
           "You're inside building.", 0);
  make_ins(ENTER, R_ROAD);
  ditto(OUT);
  ditto(OUTDOORS);
  ditto(W);
  make_ins(XYZZY, R_DEBRIS);
  make_ins(PLUGH, R_Y2);
  make_ins(DOWNSTREAM, remark(17));
  ditto(STREAM);
  make_loc(q, R_VALLEY,
           "You are in a valley in the forest beside a stream tumbling along "
           "a" SOFT_NL "rocky bed.",
           "You're in valley.", 0);
  make_ins(UPSTREAM, R_ROAD);
  ditto(HOUSE);
  ditto(N);
  make_ins(FOREST, R_FOREST);
  ditto(E);
  ...
  make_loc(q, R_FOREST,
           ...
           "You're in forest.", 0);
  make_ins(VALLEY, R_VALLEY);
  ditto(E);
  ditto(D);
  make_cond_ins(FOREST, 50, R_FOREST);
  ditto(FORWARD);
  ditto(N);
  ...
  make_ins(UPSTREAM, R_VALLEY);
  ditto(N);
  make_ins(FOREST, R_FOREST);
  ditto(E);
  ditto(W);
  make_ins(DOWNSTREAM, R_OUTSIDE);
  ditto(ROCK);
  ditto(BED);
  ditto(S);
  make_ins(SLIT, remark(0));
  ditto(STREAM);
  ditto(D);
  make_loc(q, R_OUTSIDE,
           "You are in a 20-foot depression floored with bare dirt.  Set into "
           "the" SOFT_NL "dirt is a strong steel grate mounted in concrete.  A "
                         "dry streambed" SOFT_NL "leads into the depression.",
  ...
  ditto(S);
  make_ins(HOUSE, R_ROAD);
  make_ins(UPSTREAM, R_SLIT);
  ditto(GULLY);
  ditto(N);
  make_cond_ins(ENTER, unless_prop(GRATE, 0), R_INSIDE);
  ditto(IN);
  ditto(D);
  ...
  make_cond_ins(OUT, unless_prop(GRATE, 0), R_OUTSIDE);
  ditto(U);
  make_ins(OUT, remark(1));
  make_ins(CRAWL, R_COBBLES);
  ditto(COBBLES);
  ditto(IN);
  ditto(W);
  make_ins(PIT, R_SPIT);
  ...
  make_loc(q, R_COBBLES,
           ...
           "light" SOFT_NL "at the east end of the passage.",
           "You're in cobble crawl.", 0);
  make_ins(OUT, R_INSIDE);
  ditto(SURFACE);
  ditto(E);
  make_ins(IN, R_DEBRIS);
  ditto(DARK);
  ditto(W);
  ditto(DEBRIS);
  make_ins(PIT, R_SPIT);
  make_loc(q, R_DEBRIS,
           ...
           "surface." SOFT_NL "A low wide passage with cobbles becomes plugged "
                              "with mud and debris" SOFT_NL
           "here, but an awkward canyon leads upward and west.  A note on the "
           "wall" SOFT_NL "says \"MAGIC WORD XYZZY\".",
  ...
  ditto(LOW);
  ditto(E);
  make_ins(CANYON, R_AWK);
  ditto(IN);
  ditto(U);
  ditto(W);
  make_ins(XYZZY, R_HOUSE);
  make_ins(PIT, R_SPIT);
  make_loc(q, R_AWK, "You are in an awkward sloping east/west canyon.", NULL,
           0);
  make_cond_ins(DEPRESSION, unless_prop(GRATE, 0), R_OUTSIDE);
  make_ins(ENTRANCE, R_INSIDE);
  make_ins(D, R_DEBRIS);
  ...
  make_loc(q, R_BIRD,
           ...
           "frozen" SOFT_NL "rivers of orange stone. An awkward canyon and a "
                            "good passage exit" SOFT_NL
  ...
  make_ins(ENTRANCE, R_INSIDE);
  make_ins(DEBRIS, R_DEBRIS);
  make_ins(PASSAGE, R_BIRD);
  ditto(E);
  make_cond_ins(D, only_if_toting(GOLD), R_NECK);
  ditto(PIT);
  ditto(STEPS);
  /* good thing you weren't loaded down with GOLD */
  make_ins(D, R_EMIST);
  make_ins(CRACK, remark(14));
  ditto(W);
  make_loc(
      q, R_EMIST,
      "You are at one end of a vast hall stretching forward out of sight "
      "to" SOFT_NL "the west.  There are openings to either side.  Nearby, a "
                   "wide stone" SOFT_NL
  ...
  make_ins(LEFT, R_NUGGET);
  ditto(S);
  make_ins(FORWARD, R_EFISS);
  ditto(HALL);
  ditto(W);
  make_ins(STAIRS, R_HMK);
  ditto(D);
  ditto(N);
  make_cond_ins(U, only_if_toting(GOLD), remark(15));
  ditto(PIT);
  ditto(STEPS);
  ditto(DOME);
  ditto(PASSAGE);
  ...
  make_ins(HALL, R_EMIST);
  ditto(OUT);
  ditto(N);
  make_loc(q, R_EFISS,
           "You are on the east bank of a fissure slicing clear across the "
           "hall." SOFT_NL
  ...
  make_cond_ins(OVER, unless_prop(FISSURE, 1), remark(3));
  ditto(ACROSS);
  ditto(W);
  ditto(CROSS);
  ...
  ditto(D);
  make_loc(q, R_BRINK,
           "You are on the brink of a thirty-foot pit with a massive orange "
           "column" SOFT_NL "down one wall.  You could climb down here but you "
                            "could not get back" SOFT_NL
  ...
  make_ins(E, R_LIKE13);
  make_loc(q, R_ELONG,
           "You are at the east end of a very long hall apparently without "
           "side" SOFT_NL "chambers.  To the east a low wide crawl slants up.  "
                          "To the north a" SOFT_NL
  ...
  make_loc(q, R_WLONG,
           ...
           "hall" SOFT_NL "joins up with a narrow north/south passage.",
           "You're at west end of long hall.", 0);
  make_ins(E, R_ELONG);
  make_ins(N, R_CROSS);
  make_cond_ins(S, 100, R_DIFF0); /* 100: Dwarves Not Permitted. */

  twist(R_DIFF0, R_DIFF9, R_DIFF1, R_DIFF7, R_DIFF8, R_DIFF3, R_DIFF4, R_DIFF6,
        R_DIFF2, R_DIFF5, R_WLONG,
        "You are in a maze of twisty little passages, all different.");
  twist(R_DIFF1, R_DIFF8, R_DIFF9, R_DIFF10, R_DIFF0, R_DIFF5, R_DIFF2, R_DIFF3,
        R_DIFF4, R_DIFF6, R_DIFF7,
        "You are in a maze of twisting little passages, all different.");
  twist(R_DIFF2, R_DIFF3, R_DIFF4, R_DIFF8, R_DIFF5, R_DIFF7, R_DIFF10, R_DIFF0,
        R_DIFF6, R_DIFF1, R_DIFF9,
        "You are in a little maze of twisty passages, all different.");
  twist(R_DIFF3, R_DIFF7, R_DIFF10, R_DIFF6, R_DIFF2, R_DIFF4, R_DIFF9, R_DIFF8,
        R_DIFF5, R_DIFF0, R_DIFF1,
        "You are in a twisting maze of little passages, all different.");
  twist(R_DIFF4, R_DIFF1, R_DIFF7, R_DIFF5, R_DIFF9, R_DIFF0, R_DIFF3, R_DIFF2,
        R_DIFF10, R_DIFF8, R_DIFF6,
        "You are in a twisting little maze of passages, all different.");
  twist(R_DIFF5, R_DIFF0, R_DIFF3, R_DIFF4, R_DIFF6, R_DIFF8, R_DIFF1, R_DIFF9,
        R_DIFF7, R_DIFF10, R_DIFF2,
        "You are in a twisty little maze of passages, all different.");
  twist(R_DIFF6, R_DIFF10, R_DIFF5, R_DIFF0, R_DIFF1, R_DIFF9, R_DIFF8, R_DIFF7,
        R_DIFF3, R_DIFF2, R_DIFF4,
        "You are in a twisty maze of little passages, all different.");
  twist(R_DIFF7, R_DIFF6, R_DIFF2, R_DIFF9, R_DIFF10, R_DIFF1, R_DIFF0, R_DIFF5,
        R_DIFF8, R_DIFF4, R_DIFF3,
        "You are in a little twisty maze of passages, all different.");
  twist(R_DIFF8, R_DIFF5, R_DIFF6, R_DIFF1, R_DIFF4, R_DIFF2, R_DIFF7, R_DIFF10,
        R_DIFF9, R_DIFF3, R_DIFF0,
        "You are in a maze of little twisting passages, all different.");
  twist(R_DIFF9, R_DIFF4, R_DIFF8, R_DIFF2, R_DIFF3, R_DIFF10, R_DIFF6, R_DIFF1,
        R_DIFF0, R_DIFF7, R_DIFF5,
        "You are in a maze of little twisty passages, all different.");
  twist(R_DIFF10, R_DIFF2, R_PONY, R_DIFF3, R_DIFF7, R_DIFF6, R_DIFF5, R_DIFF4,
        R_DIFF1, R_DIFF9, R_DIFF8,
  ...
  make_ins(S, R_WLONG);
  make_loc(q, R_HMK,
           "You are in the Hall of the Mountain King, with passages off in "
           "all" SOFT_NL "directions.",
           "You're in Hall of Mt King.", F_SNAKE_HINT);
  make_ins(STAIRS, R_EMIST);
  ditto(U);
  ditto(E);
  /* I suppose our adventurer must be walking on the ceiling! */
  make_cond_ins(N, unless_prop(SNAKE, 0), R_NS);
  ditto(LEFT);
  make_cond_ins(S, unless_prop(SNAKE, 0), R_SOUTH);
  ditto(RIGHT);
  make_cond_ins(W, unless_prop(SNAKE, 0), R_WEST);
  ditto(FORWARD);
  ...
  make_loc(q, R_WEST,
           "You are in the west side chamber of the Hall of the Mountain "
           "King." SOFT_NL "A passage continues west and up here.",
  ...
  make_ins(W, R_CROSS);
  ditto(U);
  make_loc(q, R_SOUTH, "You are in the south side chamber.", NULL, 0);
  make_ins(HALL, R_HMK);
  ditto(OUT);
  ditto(N);
  make_loc(q, R_NS,
           "You are in a low N/S passage at a hole in the floor.  The hole "
           "goes" SOFT_NL "down to an E/W passage.",
  ...
  make_loc(q, R_Y2,
           ...
           "the" SOFT_NL "west, and a wall of broken rock to the east.  There "
                         "is a large \"Y2\" on" SOFT_NL
  ...
  make_loc(q, R_JUMBLE, "You are in a jumble of rock, with cracks everywhere.",
           NULL, 0);
  make_ins(D, R_Y2);
  ditto(Y2);
  make_ins(U, R_EMIST);
  make_loc(
      ...
      "of" SOFT_NL "sight.  A floor is indistinctly visible over 50 feet "
                   "below.  Traces of" SOFT_NL
      "white mist cover the floor of the pit, becoming thicker to the "
      "right." SOFT_NL
      ...
      "and" SOFT_NL "25 feet away there is a similar window looking into a "
                    "lighted room." SOFT_NL
  ...
  make_loc(
      ...
      "the" SOFT_NL "north joins a higher crawl from the east to make a "
                    "walking passage" SOFT_NL
  ...
  make_loc(
      q, R_SHELL,
      "You're in a large room carved out of sedimentary rock.  The "
      "floor" SOFT_NL "and walls are littered with bits of shells embedded in "
                      "the stone." SOFT_NL
  ...
  make_loc(
      q, R_ARCHED,
      "You are in an arched hall.  A coral passage once continued up and "
      "east" SOFT_NL
  ...
  ditto(OUT);
  make_loc(q, R_RAGGED,
           "You are in a long sloping corridor with ragged sharp walls.", NULL,
           0);
  make_ins(U, R_SHELL);
  ditto(SHELL);
  make_ins(D, R_SAC);
  make_loc(q, R_SAC, "You are in a cul-de-sac about eight feet across.", NULL,
           0);
  make_ins(U, R_RAGGED);
  ditto(OUT);
  ...
  make_loc(q, R_ANTE,
           ...
           "Small" SOFT_NL "passages go west and up.  The remnants of recent "
                           "digging are evident." SOFT_NL
  ...
  make_loc(q, R_SWISS,
           "You are in a room whose walls resemble Swiss cheese.  Obvious "
           "passages" SOFT_NL "go west, east, NE, and NW.  Part of the room is "
                              "occupied by a large" SOFT_NL "bedrock block.",
  ...
  make_loc(q, R_SOFT,
           "You are in the Soft Room.  The walls are covered with heavy "
           "curtains," SOFT_NL
  ...
  make_loc(
      ...
      "pits." SOFT_NL "There is a path here bypassing the pits to connect "
                      "passages from east" SOFT_NL
      "and west.  There are holes all over, but the only big one is on "
      "the" SOFT_NL
  ...
  make_loc(q, R_W2PIT,
           ...
           "in" SOFT_NL "the wall above the pit at this end of the room.",
  ...
  make_loc(q, R_EPIT,
           ...
           "There is" SOFT_NL "a small pool of oil in one corner of the pit.",
  ...
  make_loc(
      q, R_GIANT,
      "You are in the Giant Room.  The ceiling here is too high up for "
      "your" SOFT_NL "lamp to show it.  Cavernous passages lead east, north, "
                     "and south.  On" SOFT_NL
      "the west wall is scrawled the inscription, \"FEE FIE FOE FOO\" [sic].",
      "You're in Giant Room.", 0);
  make_ins(S, R_NARROW);
  make_ins(E, R_BLOCK);
  make_ins(N, R_IMMENSE);
  make_loc(q, R_BLOCK, "The passage here is blocked by a recent cave-in.", NULL,
           0);
  make_ins(S, R_GIANT);
  ditto(GIANT);
  ditto(OUT);
  make_loc(q, R_IMMENSE,
           "You are at one end of an immense north/south passage.", NULL, 0);
  make_ins(S, R_GIANT);
  ditto(GIANT);
  ditto(PASSAGE);
  make_cond_ins(N, unless_prop(RUSTY_DOOR, 0), R_FALLS);
  ditto(ENTER);
  ditto(CAVERN);
  make_ins(N, remark(9));
  make_loc(q, R_FALLS,
           "You are in a magnificent cavern with a rushing stream, which "
           "cascades" SOFT_NL "over a sparkling waterfall into a roaring "
                              "whirlpool that disappears" SOFT_NL
           "through a hole in the floor.  Passages exit to the south and west.",
           "You're in cavern with waterfall.", 0);
  make_ins(S, R_IMMENSE);
  ditto(OUT);
  make_ins(GIANT, R_GIANT);
  make_ins(W, R_INCLINE);
  make_loc(q, R_INCLINE,
           "You are at the top of a steep incline above a large room.  You "
           "could" SOFT_NL "climb down here, but you would not be able to "
                           "climb up.  There is a" SOFT_NL
  ...
  ditto(CLIMB);
  make_loc(q, R_ABOVEP,
           "You are in a secret N/S canyon above a sizable passage.", NULL, 0);
  make_ins(N, R_SJUNC);
  make_ins(D, R_BEDQUILT);
  ditto(PASSAGE);
  make_ins(S, R_TITE);
  make_loc(
      q, R_SJUNC,
  ...
  /* In Crowther's original, this was pretty much the edge of the cave. Going UP
   * here would take you on a one-way trip back to the dusty rock room. Woods
   * replaced that connection with a northerly passage to R_WINDOW. */
  make_ins(SE, R_BEDQUILT);
  make_ins(S, R_ABOVEP);
  make_ins(N, R_WINDOW);
  make_loc(q, R_TITE,
           "A large stalactite extends from the roof and almost reaches the "
           "floor" SOFT_NL "below.  You could climb down it, and jump from it "
                           "to the floor, but" SOFT_NL
           "having done so you would be unable to reach it to climb back up.",
           "You're at top of stalactite.", 0);
  make_ins(N, R_ABOVEP);
  make_cond_ins(D, 40, R_LIKE6);
  ditto(JUMP);
  ditto(CLIMB);
  make_cond_ins(D, 50, R_LIKE9);
  make_ins(D, R_LIKE4);
  make_loc(q, R_LOW,
           "You are in a large low room.  Crawls lead north, SE, and SW.", NULL,
           0);
  make_ins(BEDQUILT, R_BEDQUILT);
  make_ins(SW, R_SLOPING);
  make_ins(N, R_CRAWL);
  make_ins(SE, R_ORIENTAL);
  ditto(ORIENTAL);
  make_loc(q, R_CRAWL, "Dead end crawl.", NULL, 0);
  make_ins(S, R_LOW);
  ditto(CRAWL);
  ditto(OUT);
  make_loc(
  ...
  make_loc(q, R_ORIENTAL,
           "This is the Oriental Room.  Ancient oriental cave drawings cover "
           "the" SOFT_NL "walls.  A gently sloping passage leads upward to the "
                         "north, another" SOFT_NL
  ...
  make_loc(q, R_MISTY,
           ...
           "cavern." SOFT_NL "Far below, through a heavy white mist, strange "
                             "splashing noises can be" SOFT_NL
           "heard.  The mist rises up through a fissure in the ceiling.  The "
           "path" SOFT_NL "exits to the south and west.",
           "You're in misty cavern.", 0);
  make_ins(S, R_ORIENTAL);
  ditto(ORIENTAL);
  make_ins(W, R_ALCOVE);
  make_loc(q, R_ALCOVE,
           "You are in an alcove.  A small NW path seems to widen after a "
           "short" SOFT_NL "distance.  An extremely tight tunnel leads east.  "
                           "It looks like a very" SOFT_NL
  ...
  make_loc(q, R_SLAB,
           ...
           "slab" SOFT_NL "fallen from the ceiling (Slab Room).  There once "
                          "were large passages" SOFT_NL
           "to the east and west, but they are now filled with boulders.  "
           "Low" SOFT_NL "small passages go north and south, and the south one "
                         "quickly bends" SOFT_NL "east around the boulders.",
           "You're in Slab Room.", 0);
  make_ins(S, R_W2PIT);
  make_ins(U, R_ABOVER);
  ditto(CLIMB);
  make_ins(N, R_BEDQUILT);
  make_loc(q, R_ABOVER, "You are in a secret N/S canyon above a large room.",
           NULL, 0);
  make_ins(D, R_SLAB);
  ditto(SLAB);
  ...
  make_loc(
      q, R_MIRROR,
      "You are in a north/south canyon about 25 feet across.  The floor "
      "is" SOFT_NL "covered by white mist seeping in from the north.  The "
                   "walls extend" SOFT_NL
      "upward for well over 100 feet.  Suspended from some unseen point "
      "far" SOFT_NL "above you, an enormous two-sided mirror is hanging "
                    "parallel to and" SOFT_NL
      "midway between the canyon walls.  (The mirror is obviously "
      "provided" SOFT_NL
  ...
  make_loc(q, R_RES,
           ...
           "cloud" SOFT_NL "of white mist fills the room and rises rapidly "
                           "upward.  The lake is" SOFT_NL
           "fed by a stream, which tumbles out of a hole in the wall about 10 "
           "feet" SOFT_NL "overhead and splashes noisily into the water "
                          "somewhere within the" SOFT_NL
   ...
   */
  make_loc(q, R_SCAN1,
           "You are in a secret canyon that exits to the north and east.", NULL,
           0);
  make_ins(N, R_ABOVER);
  ditto(OUT);
  make_ins(E, remark(10));
  ditto(FORWARD);
  make_loc(q, R_SCAN2, places[R_SCAN1].long_desc, NULL, 0);
  make_ins(N, R_ABOVER);
  make_ins(E, R_SECRET);
  make_loc(q, R_SCAN3, places[R_SCAN1].long_desc, NULL, 0);
  make_ins(E, R_SECRET);
  ditto(OUT);
  make_ins(N, remark(10));
  ditto(FORWARD);

  make_loc(q, R_SECRET,
           "You are in a secret canyon which here runs E/W.  It crosses over "
           "a" SOFT_NL "very tight canyon 15 feet below.  If you go down you "
                       "may not be able" SOFT_NL "to get back up.",
           "You're in secret E/W canyon above tight canyon.", 0);
  make_ins(E, R_HMK);
  make_cond_ins(W, unless_prop(DRAGON, 0), R_SCAN2);
  make_ins(W, R_SCAN3);
  make_ins(D, R_WIDE);
  make_loc(q, R_WIDE, "You are at a wide place in a very tight N/S canyon.",
           NULL, 0);
  make_ins(S, R_TIGHT);
  make_ins(N, R_TALL);
  make_loc(q, R_TIGHT, "The canyon here becomes too tight to go further south.",
           NULL, 0);
  make_ins(N, R_WIDE);
  make_loc(q, R_TALL,
           "You are in a tall E/W canyon.  A low tight crawl goes 3 feet north "
           "and" SOFT_NL "seems to open up.",
  ...
  make_ins(U, R_SWSIDE);
  make_loc(q, R_SWSIDE,
           "You are on one side of a large, deep chasm.  A heavy white mist "
           "rising" SOFT_NL "up from below obscures all view of the far side.  "
                            "A SW path leads away" SOFT_NL
  ...
  make_ins(W, R_LIKE4);
  ditto(OUT);
  make_loc(q, R_DEAD4, dead_end, NULL, F_TWIST_HINT);
  make_ins(E, R_LIKE4);
  ditto(OUT);
  make_loc(q, R_DEAD5, dead_end, NULL, F_TWIST_HINT);
  make_ins(U, R_LIKE3);
  ditto(OUT);
  make_loc(q, R_DEAD6, dead_end, NULL, F_TWIST_HINT);
  make_ins(W, R_LIKE9);
  ditto(OUT);
  make_loc(q, R_DEAD7, dead_end, NULL, F_TWIST_HINT);
  make_ins(U, R_LIKE10);
  ditto(OUT);
  make_loc(q, R_DEAD8, dead_end, NULL, 0);
  make_ins(E, R_BRINK);
  ditto(OUT);
  make_loc(q, R_DEAD9, dead_end, NULL, F_TWIST_HINT);
  make_ins(S, R_LIKE3);
  ditto(OUT);
  make_loc(q, R_DEAD10, dead_end, NULL, F_TWIST_HINT);
  make_ins(E, R_LIKE12);
  ditto(OUT);
  make_loc(q, R_DEAD11, dead_end, NULL, F_TWIST_HINT);
  make_ins(U, R_LIKE8);
  ditto(OUT);
  make_loc(q, R_NESIDE,
           "You are on the far side of the chasm.  A NE path leads away from "
           "the" SOFT_NL "chasm on this side.",
  ...
  make_loc(q, R_CORR,
           "You're in a long east/west corridor.  A faint rumbling noise can "
           "be" SOFT_NL "heard in the distance.",
  ...
  make_loc(q, R_FORK,
           ...
           "rumbling" SOFT_NL "seems to get louder in that direction.  The "
                              "right fork leads southeast" SOFT_NL
  ...
  make_loc(q, R_WARM,
           ...
           "steady" SOFT_NL "roar, so loud that the entire cave seems to be "
                            "trembling.  Another" SOFT_NL
  ...
  make_ins(N, R_VIEW);
  ditto(VIEW);
  make_ins(E, R_CHAMBER);
  ditto(CRAWL);
  make_loc(
      q, R_VIEW,
      "You are on the edge of a breath-taking view.  Far below you is "
      "an" SOFT_NL "active volcano, from which great gouts of molten lava come "
                   "surging" SOFT_NL
      "out, cascading back down into the depths.  The glowing rock fills "
      "the" SOFT_NL "farthest reaches of the cavern with a blood-red glare, "
                    "giving every" SOFT_HYPHEN
      "thing an eerie, macabre appearance.  The air is filled with "
      "flickering" SOFT_NL "sparks of ash and a heavy smell of brimstone.  The "
                           "walls are hot to" SOFT_NL
      "the touch, and the thundering of the volcano drowns out all "
      "other" SOFT_NL "sounds.  Embedded in the jagged roof far overhead are "
                      "myriad twisted" SOFT_NL
      "formations, composed of pure white alabaster, which scatter the "
      "murky" SOFT_NL "light into sinister apparitions upon the walls.  To one "
                      "side is a deep" SOFT_NL
      "gorge, filled with a bizarre chaos of tortured rock that seems to "
      "have" SOFT_NL "been crafted by the Devil himself.  An immense river of "
                     "fire crashes" SOFT_NL
      "out from the depths of the volcano, burns its way through the "
      "gorge," SOFT_NL
      ...
      "from a barren island in the center of a sulfurous lake, which "
      "bubbles" SOFT_NL "ominously.  The far right wall is aflame with an "
                        "incandescence of its" SOFT_NL
  ...
  ditto(OUT);
  make_ins(FORK, R_FORK);
  make_ins(D, remark(13));
  ditto(JUMP);
  make_loc(q, R_CHAMBER,
           "You are in a small chamber filled with large boulders.  The walls "
           "are" SOFT_NL "very warm, causing the air in the room to be almost "
                         "stifling from the" SOFT_NL
           "heat.  The only exit is a crawl heading west, through which is "
           "coming" SOFT_NL "a low rumbling.",
  ...
  make_loc(q, R_LIME,
           ...
           "with" SOFT_NL "oddly shaped limestone formations.",
  ...
  make_ins(VIEW, R_VIEW);
  make_loc(q, R_FBARR,
           "You are standing at the entrance to a large, barren room.  A "
           "sign" SOFT_NL
  ...
  make_ins(VIEW, R_VIEW);
  make_loc(q, R_BARR,
           "You are inside a barren room.  The center of the room is "
           "completely" SOFT_NL "empty except for some dust.  Marks in the "
                                "dust lead away toward the" SOFT_NL
  ...
  make_loc(
      q, R_NEEND,
      "You are at the northeast end of an immense room, even larger than "
      "the" SOFT_NL
      ...
      "yellow light.  Scattered about you can be seen a pile of bottles "
      "(all" SOFT_NL "of them empty), a nursery of young beanstalks murmuring "
                     "quietly, a bed" SOFT_NL
      "of oysters, a bundle of black rods with rusty stars on their ends, "
      "and" SOFT_NL "a collection of brass lanterns.  Off to one side a great "
                    "many dwarves" SOFT_NL
      "are sleeping on the floor, snoring loudly.  A sign nearby reads: "
      "\"DO" SOFT_NL "NOT DISTURB THE DWARVES!\"  An immense mirror is hanging "
                     "against one" SOFT_NL
      "wall, and stretches to the other end of the room, where various "
      "other" SOFT_NL "sundry objects can be glimpsed dimly in the distance.",
      "You're at NE end.", 0);
  make_ins(SW, R_SWEND);
  /* The following description has several minor differences from Woods'
   * original. Woods' line breaks come after "A" on lines 4 and 5, "large" on
   * line 6, and "vault" on line 7. Knuth's "that reads" corresponds to Woods'
   * "which reads";
   * presumably Knuth changed it to avoid ugly repetition, and I agree. */
  make_loc(
      q, R_SWEND,
      "You are at the southwest end of the repository.  To one side is a "
      "pit" SOFT_NL "full of fierce green snakes.  On the other side is a row "
                    "of small" SOFT_NL "wicker cages, each of which contains a "
                                       "little sulking bird.  In one" SOFT_NL
      "corner is a bundle of black rods with rusty marks on their ends." SOFT_NL
      "A large number of velvet pillows are scattered about on the "
      "floor." SOFT_NL
      "A vast mirror stretches off to the northeast.  At your feet is a" SOFT_NL
      "large steel grate, next to which is a sign that reads, "
      "\"TREASURE" SOFT_NL "VAULT.  KEYS IN MAIN OFFICE.\"",
      "You're at SW end.", 0);
  make_ins(NE, R_NEEND);
   ...
   */
  make_loc(q, R_NECK, "You are at the bottom of the pit with a broken neck.",
           NULL, 0);
  make_ins(0, R_LIMBO);
  ...
  make_loc(q, R_THRU,
           ...
           "north" SOFT_NL "of the Hall of Mists.",
           NULL, 0);
  make_ins(0, R_WMIST);
  ...
  make_loc(q, R_UPNOUT,
           ...
           NULL, 0);
  make_ins(0, R_WPIT);
  make_loc(q, R_DIDIT, "You have climbed up the plant and out of the pit.",
           NULL, 0);
  make_ins(0, R_W2PIT);
...
bool has_oil(Location loc) { return (loc == R_EPIT); }
...
#define objs(t) (objs_[(int)(t)-MIN_OBJ])
...
bool here(ObjectWord t, Location loc) { return toting(t) || there(t, loc); }
...
void drop(ObjectWord t, Location l) 
{
  ...
  if (l == R_INHAND) {
    ...
    objs(t).link = places[(int)l].objects;
    places[(int)l].objects = t;
  }
}
...
void carry(ObjectWord t) 
{
  ...
  if (l != R_INHAND) {
    if (l > R_LIMBO) {
      ...
      ObjectWord *p = &places[(int)l].objects;
      while (*p != t)
        p = &objs(*p).link;
      *p = objs(*p).link;
    }
...
void build_object_table(void) 
{
  ...
  objs(RUSTY_DOOR).desc[0] =
      "The way north is barred by a massive, rusty, iron door.";
  objs(RUSTY_DOOR).desc[1] =
  ...
  objs(PLANT).desc[0] = "There is a tiny little plant in the pit, murmuring "
                        "\"Water, water, ...\"";
  objs(PLANT).desc[1] =
  ...
  objs(CHASM).desc[1] = "The wreckage of a bridge (and a dead bear) can be "
                        "seen at the bottom" SOFT_NL "of the chasm.";
  ...
  objs(BEAR).desc[3] =
      NULL; /* the dead bear remains as scenery where it fell */
...
struct Dwarf {
  ...
  Location loc;
    ...
    {false, R_LIMBO, R_HMK},          {false, R_LIMBO, R_WFISS},
    {false, R_LIMBO, R_Y2},           {false, R_LIMBO, R_LIKE3},
...
{
  int t;
  puts("Out from the shadows behind you pounces a bearded pirate!  \"Har, "
       "har,\"" SOFT_NL "he chortles. \"I'll just take all this booty and hide "
                        "it away with me" SOFT_NL
       "chest deep in the maze!\"  He snatches your treasure and vanishes "
       "into" SOFT_NL "the gloom.");
  for (t = MIN_OBJ; t <= MAX_OBJ; ++t) {
    if (!is_treasure(t))
      continue;
    if (too_easy_to_steal(t, loc))
      continue;
...
void pirate_tracks_you(Location loc)
{
  ...
  if (loc == R_PIRATES_NEST || objs(CHEST).prop >= 0)
    return;
  for (i = MIN_OBJ; i <= MAX_OBJ; ++i) {
    if (!is_treasure(i))
      continue;
    if (too_easy_to_steal(i, loc))
      continue;
    if (toting(i)) {
  ...
  if (tally == lost_treasures + 1 && !stalking && chest_needs_placing &&
    ...
    puts("There are faint rustling noises from the darkness behind you. As "
         "you" SOFT_NL "turn toward them, the beam of your lamp falls across a "
                       "bearded pirate." SOFT_NL
         "He is carrying a large chest. \"Shiver me timbers!\" he cries, "
         "\"I've" SOFT_NL "been spotted! I'd best hie meself off to the maze "
                          "to hide me chest!\"" SOFT_NL
...
bool forbidden_to_pirate(Location loc) { return (loc > R_PIRATES_NEST); }
...
bool move_dwarves_and_pirate(Location loc)
{
  ...
  if (forbidden_to_pirate(loc) || loc == R_LIMBO) {
    ...
    if (loc >= MIN_LOWER_LOC && pct(5)) {
      ...
      dflag = 2;
      if (pct(50))
        dwarves[1 + ran(5)].loc = R_LIMBO;
      if (pct(50))
        dwarves[1 + ran(5)].loc = R_LIMBO;
      for (j = 1; j <= 5; ++j) {
        if (dwarves[j].loc == loc)
          dwarves[j].loc = R_NUGGET;
      ...
      puts("A little dwarf just walked around a corner, saw you, threw a "
           "little" SOFT_NL "axe at you which missed, cursed, and ran away.");
      drop(AXE, loc);
    }
  } else {
    ...
    for (j = 0; j <= 5; ++j) {
      ...
      if (d->loc != R_LIMBO) {
         ...
         * Dwarves think R_SCAN1, R_SCAN2, R_SCAN3 are three different
         * locations, although you will never have that perception. */
        for (q = start[(int)d->loc]; q < start[(int)d->loc + 1]; ++q) {
          Location newloc = q->dest;
          if (i != 0 && newloc == ploc[i - 1])
            continue;
          if (newloc < MIN_LOWER_LOC)
            continue; /* don't wander above level 2 */
          if (newloc == d->oldloc || newloc == d->loc)
            continue; /* don't double back */
          if (q->cond == 100)
            continue;
          if (d == pirate && forbidden_to_pirate(newloc))
            continue;
          if (is_forced(newloc) || newloc > MAX_LOC)
            continue;
          ploc[i++] = newloc;
        }
        if (i == 0)
...
bool cave_is_closing(void) { return (clock1 < 0); }
...
void close_the_cave(void) 
{
  ...
  puts("The sepulchral voice intones, \"The cave is now closed.\"  As the "
       "echoes" SOFT_NL "fade, there is a blinding flash of light (and a small "
                        "puff of orange" SOFT_NL
       "smoke). . . .    As your eyes refocus, you look around and find...");
  move(BOTTLE, R_NEEND);
  objs(BOTTLE).prop = -2; /* empty */
  move(PLANT, R_NEEND);
  objs(PLANT).prop = -1;
  move(OYSTER, R_NEEND);
  objs(OYSTER).prop = -1;
  ...
  objs(GRATE).prop = 0;
  move(SNAKE, R_SWEND);
  objs(SNAKE).prop = -2; /* not blocking the way */
  move(BIRD, R_SWEND);
  objs(BIRD).prop = -2; /* caged */
  move(CAGE, R_SWEND);
  objs(CAGE).prop = -1;
  move(ROD2, R_SWEND);
  objs(ROD2).prop = -1;
...
bool check_clocks_and_lamp(Location loc) 
{
  ...
  if (clock1 == 0) {
    ...
    puts("A sepulchral voice, reverberating through the cave, says "
         "\"Cave" SOFT_NL "closing soon.  All adventurers exit immediately "
                          "through main office.\"");
    clock1 = -1;
    objs(GRATE).prop = 0;
    objs(FISSURE).prop = 0;
    ...
    destroy(TROLL);
    destroy(TROLL_);
    move(NO_TROLL, R_SWSIDE);
    move(NO_TROLL_, R_NESIDE);
    juggle(CHASM);
    juggle(CHASM_);
    if (objs(BEAR).prop != 3)
      destroy(BEAR);
    ...
    if (clock2 == 0) {
      ...
      if (objs(LAMP).prop == 1)
        --lamp_limit;
      if (lamp_limit <= 30 && here(LAMP, loc) && here(BATTERIES, loc) &&
          objs(BATTERIES).prop == 0) {
        puts("Your lamp is getting dim.  I'm taking the liberty of "
             "replacing" SOFT_NL "the batteries.");
        ...
        puts("There's not much point in wandering around out here, and you "
             "can't" SOFT_NL
        ...
        if (objs(BATTERIES).prop == 1) {
          ...
          puts(".  You'd best start wrapping this up, unless" SOFT_NL
               "you can find some fresh batteries.  I seem to recall that "
               "there's" SOFT_NL
...
void describe_object(ObjectWord t, Location loc)
{
  ...
  going_up = (t == TREADS && loc == R_EMIST);
  obj_description = objs(t).desc[objs(t).prop + going_up];
...
int look_around(Location loc, bool dark, bool was_dark)
{
  ...
  if (dark && !is_forced(loc)) {
    if (was_dark && pct(35))
      return 'p'; /* goto pitch_dark; */
    room_description = pitch_dark_msg;
  } else if (places[(int)loc].short_desc == NULL ||
             places[(int)loc].visits % verbose_interval == 0) {
    room_description = places[(int)loc].long_desc;
  } else {
    room_description = places[(int)loc].short_desc;
  }
  if (toting(BEAR)) {
  ...
  if (is_forced(loc))
    return 't'; /* goto try_move; */
  give_optional_plugh_hint(loc);
  if (!dark) {
    ObjectWord t;
    places[(int)loc].visits += 1;
    /* Describe the objects at this location. */
    for (t = places[(int)loc].objects; t != NOTHING; t = objs(t).link) {
      ObjectWord tt = objs(t).base ? objs(t).base : t;
      if (closed && (objs(tt).prop < 0))
        continue; /* scenery objects */
      spot_treasure(tt);
...
struct {
  ...
  const char *hint;
    ...
    {0, false, 0, 5, "Welcome to Adventure!!  Would you like instructions?",
     ...
     "in" SOFT_NL "treasure and gold, though it is rumored that some who enter "
                  "are never" SOFT_NL "seen again.  Magic is said to work in "
                                      "the cave.  I will be your eyes" SOFT_NL
     "and hands.  Direct me with commands of 1 or 2 words.  I should "
     "warn" SOFT_NL "you that I look at only the first five letters of each "
                    "word, so you'll" SOFT_NL
     "have to enter \"NORTHEAST\" as \"NE\" to distinguish it from "
     "\"NORTH\"." SOFT_NL "(Should you get stuck, type \"HELP\" for some "
                          "general hints.  For infor" SOFT_HYPHEN
    ...
    {0, false, 0, 10,
     "Hmmm, this looks like a clue, which means it'll cost you 10 points "
     "to" SOFT_NL "read it.  Should I go ahead and read it anyway?",
     "It says, \"There is something strange about this place, such that "
     "one" SOFT_NL "of the words I've always known now has a new effect.\""},
    {0, false, 4, 2, "Are you trying to get into the cave?",
     "The grate is very solid and has a hardened steel lock.  You "
     "cannot" SOFT_NL "enter without a key, and there are no keys in sight.  I "
                      "would recommend" SOFT_NL
     "looking elsewhere for the keys."},
    {0, false, 5, 2, "Are you trying to catch the bird?",
     "Something seems to be frightening the bird just now and you "
     "cannot" SOFT_NL
     "catch it no matter what you try. Perhaps you might try later."},
    {0, false, 8, 2, "Are you trying to deal somehow with the snake?",
     "You can't kill the snake, or drive it away, or avoid it, or "
     "anything" SOFT_NL "like that.  There is a way to get by, but you don't "
                        "have the necessary" SOFT_NL "resources right now."},
    ...
    {0, false, 25, 5, "Are you trying to explore beyond the Plover Room?",
     "There is a way to explore that region without having to worry "
     "about" SOFT_NL
...
{
  if (j > 1) {
    if (!yes(hints[j].prompt, " I am prepared to give you a hint,", ok))
      return;
  ...
  for (j = 2; j <= 7; ++j, k <<= 1) {
    ...
    if (++hints[j].count >= hints[j].thresh) {
      ...
      case 5: /* How to map the twisty passages all alike. */
        if (places[(int)loc].objects == NOTHING &&
            places[(int)oldloc].objects == NOTHING &&
            places[(int)oldoldloc].objects == NOTHING && holding_count > 1) {
          offer(j);
        }
        hints[j].count = 0;
        break;
...
int score(void)
{
  ...
  if (!gave_up)
    s += 4;
  if (there(MAG, R_WITT))
    s += 1; /* last lousy point */
  if (cave_is_closing())
    s += 25; /* bonus for making it this far */
  s += bonus;
  for (i = 0; i < 8; ++i) {
    if (hints[i].given)
      s -= hints[i].cost;
...
const char *death_wishes[2 * MAX_DEATHS] = {
  ...
  "to" SOFT_NL "help you out, but I've never really done this before.  Do "
               "you want me" SOFT_NL "to try to reincarnate you?",
  "All right. But don't blame me if something goes wr......\n"
  "                   --- POOF!! ---\n"
  "You are engulfed in a cloud of orange smoke.  Coughing and "
  "gasping," SOFT_NL "you emerge from the smoke and find....",
...
void kill_the_player(Location last_safe_place)
{
  ...
  objs(WATER).place = R_LIMBO;
  objs(OIL).place = R_LIMBO;
  for (j = MAX_OBJ; j >= MIN_OBJ; --j) {
    if (toting(j))
      drop(j, (j == LAMP) ? R_ROAD : last_safe_place);
  }
}
...
void adjustments_before_listening(Location loc) {
  ...
  if (closed) {
    ...
    if (objs(OYSTER).prop < 0 && toting(OYSTER)) {
      puts("Interesting. There seems to be something written on the underside "
           "of" SOFT_NL "the oyster.");
    }
    for (j = MIN_OBJ; j <= MAX_OBJ; ++j) {
...
Location attempt_plover_passage(Location from) /* section 149 in Knuth */
{
  if (holding_count == !!toting(EMERALD))
    return R_ALCOVE + R_PLOVER - (int)from;
  puts(
      "Something you're carrying won't fit through the tunnel with you." SOFT_NL
...
bool take_bird_or_cage(ObjectWord obj) {
  if (obj == BIRD && !objs(BIRD).prop) {
    if (toting(ROD)) {
      puts("The bird was unafraid when you entered, but as you approach it "
           "becomes" SOFT_NL "disturbed and you cannot catch it.");
      return true;
    } else if (!toting(CAGE)) {
...
void attempt_drop(ObjectWord obj, Location loc) {
  ...
  if (!toting(obj)) {
    ...
    destroy(TROLL);
    destroy(TROLL_);
    drop(NO_TROLL, R_SWSIDE);
    drop(NO_TROLL_, R_NESIDE);
    objs(TROLL).prop = 2;
    juggle(CHASM);
    juggle(CHASM_); /* put first in their lists */
    drop(BEAR, loc);
  } else if (obj == BIRD && here(SNAKE, loc)) {
    puts("The little bird attacks the green snake, and in an astounding "
         "flurry" SOFT_NL "drives the snake away.");
    if (closed)
      dwarves_upset();
    drop(BIRD, loc);
    ...
    puts("The little bird attacks the green dragon, and in an astounding "
         "flurry" SOFT_NL "gets burnt to a cinder.  The ashes blow away.");
    destroy(BIRD);
    objs(BIRD).prop = 0; /* no longer in the cage */
    ...
    if (obj == WATER && objs(BOTTLE).prop == 0)
      obj = BOTTLE;
    if (obj == OIL && objs(BOTTLE).prop == 2)
      obj = BOTTLE;
    if (obj == BOTTLE && bottle_contents() != NOTHING) {
...
{
  if (obj == ROD && (loc == R_EFISS || loc == R_WFISS) && toting(ROD) &&
      !cave_is_closing()) {
...
void attempt_blast(Location loc) /* section 99 in Knuth */
{
  if (closed && objs(ROD2).prop >= 0) {
    if (here(ROD2, loc)) {
      bonus = 25;
      puts("There is a loud explosion and you are suddenly splashed across "
           "the" SOFT_NL "walls of the room.");
    } else if (loc == R_NEEND) {
      bonus = 30;
      puts("There is a loud explosion and a twenty-foot hole appears in the "
           "far" SOFT_NL "wall, burying the snakes in the rubble. A river of "
                         "molten lava pours" SOFT_NL
           "in through the hole, destroying everything in its path, including "
           "you!");
    } else {
      bonus = 45;
      puts("There is a loud explosion and a twenty-foot hole appears in the "
           "far" SOFT_NL "wall, burying the dwarves in the rubble.  You march "
                         "through the hole" SOFT_NL
           "and find yourself in the main office, where a cheering band "
           "of" SOFT_NL "friendly elves carry the conquering adventurer off "
                        "into the sunset.");
    }
    quit();
  } else {
...
{
  if (obj == LAMP) {
    puts("Rubbing the electric lamp is not particularly rewarding. "
         "Anyway," SOFT_NL "nothing exciting happens.");
  } else {
...
void attempt_find(ObjectWord obj, Location loc) /* section 100 in Knuth */
{
  if (toting(obj)) {
    ...
    if (is_at_loc(obj, loc)) {
      its_right_here = true;
    } else if (obj != NOTHING && obj == bottle_contents() &&
               there(BOTTLE, loc)) {
      its_right_here = true;
    ...
    if (its_right_here) {
      ...
      puts("I can only tell you what you see as you move about and "
           "manipulate" SOFT_NL
...
void attempt_break(ObjectWord obj, Location loc) /* section 101 in Knuth */
{
  if (obj == VASE && objs(VASE).prop == 0) {
    ...
    if (closed) {
      puts("You strike the mirror a resounding blow, whereupon it shatters "
           "into a" SOFT_NL "myriad tiny fragments.");
      dwarves_upset();
    } else {
...
{
  if (closed && obj == DWARF) {
    puts("You prod the nearest dwarf, who wakes up grumpily, takes one look "
         "at" SOFT_NL "you, curses, and grabs for his axe.");
    dwarves_upset();
  }
  puts("Don't be ridiculous!");
}
...
void kill_a_dwarf(Location loc)
{
  int j;
  if (first_time) {
    puts("You killed a little dwarf.  The body vanishes in a cloud of "
         "greasy" SOFT_NL "black smoke.");
    first_time = false;
  } else {
...
bool attempt_fill(ObjectWord obj, Location loc) /* sections 110--111 in Knuth */
{
  if (obj == VASE) {
    if (!has_oil(loc) && !has_water(loc)) {
      ...
      puts("The sudden change in temperature has delicately shattered the "
           "vase.");
      objs(VASE).prop = 1; /* worthless shards */
      drop(VASE, loc);
      immobilize(VASE);
...
void attempt_feed(ObjectWord obj, Location loc) /* section 129 in Knuth */
{
  switch (obj) {
  case BIRD:
    puts("It's not hungry (it's merely pinin' for the fjords).  Besides, "
         "you" SOFT_NL "have no bird seed.");
    break;
  case TROLL:
  ...
  case BEAR:
    if (here(FOOD, loc)) {
      ...
      puts("The bear eagerly wolfs down your food, after which he seems to "
           "calm" SOFT_NL
  ...
  case DWARF:
    if (here(FOOD, loc)) {
      ++dflag;
      puts("You fool, dwarves eat only coal!  Now you've made him *REALLY* "
           "mad!!");
    } else {
      puts("There is nothing here to eat.");
    }
...
void attempt_open_or_close(ActionWord verb, ObjectWord obj,
                           Location loc) /* sections 130--134 in Knuth */
{
  ...
  case CLAM: {
    ...
    if (!verb_is_open) {
      ...
      drop(OYSTER, loc);
      drop(PEARL, R_SAC);
      puts("A glistening pearl falls out of the clam and rolls away.  "
           "Goodness," SOFT_NL "this must really be an oyster.  (I never was "
                               "very good at identifying" SOFT_NL
           "bivalves.)  Whatever it is, it has now snapped shut again.");
    } else {
      puts(
          "The oyster creaks open, revealing nothing but oyster inside." SOFT_NL
  ...
  case CHAIN:
    if (!here(KEYS, loc)) {
      ...
      if (objs(CHAIN).prop == 0) {
        ...
        puts("There is no way to get past the bear to unlock the chain, which "
             "is" SOFT_NL "probably just as well.");
      } else {
        objs(CHAIN).prop = 0;
        mobilize(CHAIN);
        if (objs(BEAR).prop == 1) {
...
bool have_tried_to_get_knife = false;
int check_noun_validity(ObjectWord obj, Location loc) /* sections 90--91 in Knuth */
{
  ...
  switch (obj) {
    ...
    case WATER:
      if (has_water(loc))
        return 0;
      if (here(BOTTLE, loc) && bottle_contents() == WATER)
        return 0;
      return 'c';
    case OIL:
      if (has_oil(loc))
        return 0;
      if (here(BOTTLE, loc) && bottle_contents() == OIL)
        return 0;
      return 'c';
  }
  return 'c';
...
{
  Instruction *q;
  for (q = start[(int)loc]; q < start[(int)loc + 1]; ++q) {
    if (is_forced(loc) || q->mot == mot)
      break;
  }
  if (q == start[(int)loc + 1]) {
  ...
  while (true) {
    ...
    if (cond == 0) {
      ...
      if (pct(cond))
        break; /* dwarves won't take these routes */
    } else if (cond <= 200) {
      if (toting(MIN_OBJ + cond % 100))
        break;
    } else if (cond <= 300) {
      if (is_at_loc(MIN_OBJ + cond % 100, loc))
        break;
    } else {
      if (objs(MIN_OBJ + cond % 100).prop != (cond / 100) - 3)
        break;
    }
...
void report_inapplicable_motion(MotionWord mot, ActionWord verb)
{
  if (mot == CRAWL) {
    ...
    switch (mot) {
      ...
      case IN:
      case OUT:
        puts("I don't know in from out here.  Use compass points or name "
             "something" SOFT_NL "in the general direction you want to go.");
        break;
      case FORWARD:
      case LEFT:
      case RIGHT:
        puts("I am unsure how you are facing.  Use compass points or nearby "
             "objects.");
        break;
      default:
...
void print_remark(int which)
{
  switch (which) {
    ...
    case 5:
      ...
      break;
    case 6:
      puts("You have crawled around in some little holes and wound up back in "
           "the" SOFT_NL "main passage.");
      break;
    case 7:
      puts("You have crawled around in some little holes and found your "
           "way" SOFT_NL
    ...
    case 16:
      ...
      break;
    case 17:
      puts("The stream flows out through a pair of 1-foot-diameter sewer "
           "pipes." SOFT_NL "It would be advisable to use the exit.");
      break;
  }
}
...
{
  puts(
    "Just as you reach the other side, the bridge buckles beneath the" SOFT_NL
    "weight of the bear, who was still following you around.  You" SOFT_NL
    "scrabble desperately for support, but as the bridge collapses "
    "you" SOFT_NL "stumble back and fall into the chasm.");
  objs(CHASM).prop = 1;
  objs(TROLL).prop = 2;
...
/* Modify newloc in place, and return true if the player died crossing the troll
 * bridge. */
  ...
  switch (msg) {
    ...
    case HELP:
      puts(
          ...
          "words" SOFT_NL "like forest, building, downstream, enter, east, west, "
                          "north, south," SOFT_NL
          "up, or down. I know about a few special objects, like a black "
          "rod" SOFT_NL "hidden in the cave. These objects can be manipulated "
                        "using some of" SOFT_NL
          "the action words that I know. Usually you will need to give both "
          "the" SOFT_NL "object and action words (in either order), but "
                        "sometimes I can infer" SOFT_NL
          "the object from the verb alone. Some objects also imply verbs; "
          "in" SOFT_NL "particular, \"inventory\" implies \"take inventory\", "
                       "which causes me to" SOFT_NL
          ...
          "having" SOFT_NL "trouble moving just need to try a few more words. "
                           "Usually people" SOFT_NL
          ...
          "distances with a single word. For example, \"building\" usually "
          "gets" SOFT_NL "you to the building from anywhere above ground except "
                         "when lost in the" SOFT_NL
          "forest. Also, note that cave passages turn a lot, and that leaving "
          "a" SOFT_NL "room to the north does not guarantee entering the next "
                      "from the south." SOFT_NL "Good luck!");
      break;
    case TREES:
      puts("The trees of the forest are large hardwood oak and maple, with "
           "an" SOFT_NL "occasional grove of pine or spruce.  There is quite a "
                        "bit of under" SOFT_HYPHEN
           "growth, largely birch and ash saplings plus nondescript bushes "
           "of" SOFT_NL "various sorts.  This time of year visibility is quite "
                        "restricted by" SOFT_NL
           "all the leaves, but travel is quite easy if you detour around "
           "the" SOFT_NL "spruce and berry bushes.");
      break;
    case DIG:
      puts("Digging without a shovel is quite impractical.  Even with a "
           "shovel" SOFT_NL "progress is unlikely.");
      break;
    case LOST:
      puts("I'm as confused as you are.");
      break;
    case MIST:
      puts("Mist is a white vapor, usually water, seen from time to time "
           "in" SOFT_NL "caverns.  It can be found anywhere but is frequently a "
                        "sign of a deep" SOFT_NL "pit leading down to water.");
      break;
    case FUCK:
      puts("Watch it!");
      break;
    case STOP:
      puts("I don't know the word \"stop\".  Use \"quit\" if you want to give "
           "up.");
      break;
    case INFO:
      puts(
          "If you want to end your adventure early, say \"quit\". To get "
          "full" SOFT_NL "credit for a treasure, you must have left it safely in "
                         "the building," SOFT_NL
          "though you get partial credit just for locating it. You lose "
          "points" SOFT_NL "for getting killed, or for quitting, though the "
                           "former costs you more." SOFT_NL
          "There are also points based on how much (if any) of the cave "
          "you've" SOFT_NL "managed to explore; in particular, there is a large "
                           "bonus just for" SOFT_NL
          "getting in (to distinguish the beginners from the rest of the "
          "pack)," SOFT_NL "and there are other ways to determine whether you've "
                           "been through some" SOFT_NL
          "of the more harrowing sections. If you think you've found all "
          "the" SOFT_NL "treasures, just keep exploring for a while. If nothing "
                        "interesting" SOFT_NL
          "happens, you haven't found them all yet. If something "
          "interesting" SOFT_NL "DOES happen, it means you're getting a bonus "
                                "and have an opportunity" SOFT_NL
          "to garner many more points in the master's section." SOFT_NL
          "I may occasionally offer hints if you seem to be having "
          "trouble." SOFT_NL "If I do, I'll warn you in advance how much it will "
                             "affect your score" SOFT_NL
...
const char *const incantation[] = {"fee", "fie", "foe", "foo", "fum"};
    ...
    switch (state) {
      ...
      case state_commence:
        ...
        switch (look_around(loc, now_in_darkness(loc), was_dark)) {
          case 'p':
            state = state_pitch_dark; goto next;
          case 't':
            state = state_try_move; goto next;
          default:
            break;
        }
      ...
      case state_pre_parse:
        ...
        if (verb == SAY) {
          ...
          if (word2[0] != '\0') {
            ...
            state = state_transitive; goto next;
          }
        }
        ...
        if (streq(word1, "enter")) {
          if (streq(word2, "water") || streq(word2, "strea")) {
            ...
            state = state_loop_2; goto next;
          } else if (word2[0] != '\0') {
            /* ENTER TUNNEL becomes just TUNNEL. */
            shift_words();
            state = state_parse; goto next;
          }
        }
        ...
        switch (word_class(k)) {
          ...
          case WordClass_Object:
            ...
            switch (check_noun_validity(obj, loc)) {
              case 'c':
                state = state_cant_see_it; goto next;
              case 'd':
                mot = DEPRESSION;
                state = state_try_move; goto next;
              case 'e':
          ...
          case WordClass_Action:
            ...
            if (verb == SAY) {
              ...
              if (word2[0] == '\0') {
                state = state_intransitive; goto next;
              } else {
                state = state_transitive; goto next;
              }
            }
      ...
      case state_intransitive:
        switch (verb) {
          ...
          case TAKE: {
            ...
            ObjectWord object_here = places[(int)loc].objects;
            if (dwarf_at(loc)) {
              state = state_get_object; goto next;
            }
          ...
          case BRIEF:
            ...
            look_count = 3;
            puts("Okay, from now on I'll only describe a place in full the first "
                 "time" SOFT_NL
          ...
          case FEEFIE: {
            ...
            if (foobar == -k) {
              ...
              if (there(EGGS, R_LIMBO) && there(TROLL, R_LIMBO) &&
                  objs(TROLL).prop == 0)
      ...
      case state_transitive:
        switch (verb) {
          ...
          case ON:
            ...
            if (was_dark) {
              state = state_commence; goto next;
            }
            state = state_loop_2; goto next;
          case OFF:
            attempt_off(loc);
          ...
          case DRINK: {
            ...
            if (evian_here) {
              ...
              puts("You have taken a drink from the stream.  The water tastes "
                   "strongly of" SOFT_NL
          ...
          case POUR:
            ...
            if (toting(obj)) {
              ...
              if (there(PLANT, loc)) {
                ...
                if (obj != WATER) {
                  puts("The plant indignantly shakes the oil off its leaves and "
                       "asks, \"Water?\"");
                  state = state_loop_2; goto next;
                } else {
                  if (objs(PLANT).prop == 0) {
                    ...
                    puts("The plant grows explosively, almost filling the bottom "
                         "of the pit.");
                    objs(PLANT).prop = 2;
                  } else if (objs(PLANT).prop == 2) {
                    puts("You've over-watered the plant! It's shriveling up! It's, "
                         "it's...");
                    objs(PLANT).prop = 0;
                  }
                ...
                switch (obj) {
                  case WATER:
                    ...
                    puts("The hinges are quite thoroughly rusted now and won't "
                         "budge.");
                    break;
                  case OIL:
                    objs(RUSTY_DOOR).prop = 1;
                    puts("The oil has freed up the hinges so that the door will now "
                         "open.");
                    break;
                }
              } else {
          ...
          case TOSS:
            ...
            if (is_treasure(obj) && is_at_loc(TROLL, loc)) {
              ...
              juggle(CHASM);
              juggle(CHASM_);
              puts("The troll catches your treasure and scurries away out of "
                   "sight.");
              state = state_loop_2; goto next;
            }
            ...
            if (dwarf_at(loc)) {
              ...
              puts("The troll deftly catches the axe, examines it carefully, and "
                   "tosses it" SOFT_NL "back, declaring, \"Good workmanship, but "
              ...
              puts("The axe misses and lands near the bear where you can't get at "
                   "it.");
              state = state_loop_2; goto next;
            } else {
              obj = NOTHING;
          ...
          case KILL:
            if (obj == NOTHING) {
              ...
              if (is_at_loc(DRAGON, loc) && !objs(DRAGON).prop) {
                ++k;
                obj = DRAGON;
              }
              if (is_at_loc(TROLL, loc)) {
                ++k;
                obj = TROLL;
              }
              if (here(BEAR, loc) && !objs(BEAR).prop) {
                ++k;
                obj = BEAR;
              }
              if (k == 0) {
                /* no enemies present */
                if (here(BIRD, loc) && oldverb != TOSS) {
                  ++k;
                  obj = BIRD;
                }
                if (here(CLAM, loc) || here(OYSTER, loc)) {
                  ++k;
                  obj = CLAM;
                }
              }
            ...
            switch (obj) {
              ...
              case DRAGON:
                if (objs(DRAGON).prop) {
                  ...
                  if (streq(word1, "yes") || streq(word1, "y")) {
                    int t;
                    puts("Congratulations!  You have just vanquished a dragon with "
                         "your bare" SOFT_NL "hands! (Unbelievable, isn't it?)");
                    ...
                    state = state_pre_parse; goto next;
                  }
                }
              case CLAM:
              case OYSTER:
              ...
              case DWARF:
                ...
                state = state_loop_2; goto next;
              case TROLL:
                puts("Trolls are close relatives with the rocks and have skin as "
                     "tough as" SOFT_NL "a rhinoceros hide.  The troll fends off "
                                        "your blows effortlessly.");
                state = state_loop_2; goto next;
              case BEAR:
      ...
      case state_cant_see_it:
        if ((verb == FIND || verb == INVENTORY) && word2[0] != '\0') {
          state = state_transitive; goto next;
        }
      ...
      case state_try_move:
        ...
        if (mot == CAVE) {
           ...
           * give these messages. */
          if (loc < MIN_IN_CAVE) {
            puts("I can't see where the cave is, but hereabouts no stream can run "
                 "on" SOFT_NL "the surface for long. I would try the stream.");
          } else {
          ...
          if (++look_count <= 3) {
            puts("Sorry, but I am not allowed to give more detail.  I will repeat "
                 "the" SOFT_NL "long description of your location.");
          }
          was_dark = false; /* pretend it wasn't dark, so you won't fall into a pit */
          places[(int)loc].visits = 0;
        } else {
          if (mot == BACK) {
        ...
        state = state_loop_1; goto next;

      case state_pitch_dark:
...
void dwarves_upset(void) 
{
  puts("The resulting ruckus has awakened the dwarves.  There are now "
       "several" SOFT_NL "threatening little dwarves in the room with you!  "
                         "Most of them throw" SOFT_NL
